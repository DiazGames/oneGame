...
namespace MoreMountains.Tools
{
	public class MMTriggerAndCollision : MonoBehaviour 
	{
		...
		{
			if (Collision2DLayerMask.Contains (collision.gameObject))
			{
		...
		{
			if (Trigger2DLayerMask.Contains (collider.gameObject))
			{
		...
		{
			if (TriggerLayerMask.Contains (collider.gameObject))
			{
