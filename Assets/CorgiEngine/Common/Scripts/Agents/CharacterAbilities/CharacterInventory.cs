...
{	
	...
	public class CharacterInventory : CharacterAbility, MMEventListener<MMInventoryEvent>
	{
		...
		public virtual void OnMMEvent(MMInventoryEvent inventoryEvent)
		{
            ...
            {
                if (inventoryEvent.TargetInventoryName == this.WeaponInventoryName)
                {
                    if (_characterHandleWeapon.CurrentWeapon.WeaponID == inventoryEvent.EventItem.ItemID)
                    {
                        _characterHandleWeapon.ChangeWeapon(null, "", false);
                    }
                }
            }
		}
