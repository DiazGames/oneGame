	...
	public class CharacterPushCorgiController : CharacterAbility 
	{
		...
		public override void ProcessAbility()
		{
            ...
            if (hit && (_movement.CurrentState == CharacterStates.MovementStates.Pushing) && (_pushedObject == null))
            {
                ...
                _movementMultiplierStorage = _characterBasicMovement.PushSpeedMultiplier;
                _characterBasicMovement.PushSpeedMultiplier = _pushedObject.PushSpeed;
            }
        ...
        protected virtual void StopPushing()
        {
            ...
            _characterBasicMovement.PushSpeedMultiplier = _movementMultiplierStorage;
            _pulling = false;
        }
