...
{	
	...
	public class CharacterGravity : CharacterAbility 
	{
		...
		public virtual bool ShouldReverseInput()
		{
			...
			if (!ReverseHorizontalInputWhenUpsideDown) { return reverseInput; }
        ...
        protected virtual void DrawGravityDebug()
		{
			...
			MMDebug.DebugDrawArrow(_controller.ColliderCenterPosition, GravityDirectionVector, Colors.Cyan, _controller.Height() * 1.5f, 0.2f, 35f);
		}
	}
}
