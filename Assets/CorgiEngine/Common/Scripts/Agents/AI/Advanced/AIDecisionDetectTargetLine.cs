    ...
    public class AIDecisionDetectTargetLine : AIDecision
    {
        ...
        protected virtual bool DetectTarget()
        {
                ...
                || ((DetectionDirection == DetectionDirections.Back) && (_character.IsFacingRight)))
            {
                ...
                {
                    raycast = MMDebug.RayCast(_raycastOrigin, Vector2.left, DetectionDistance, TargetLayer, Colors.Gold, true);
                }
                else
                {
                    ...
                    MMDebug.RayCast(_raycastOrigin + Vector2.up * RayWidth/2f, Vector2.left, DetectionDistance, TargetLayer, Colors.Gold, true);
                    MMDebug.RayCast(_raycastOrigin - Vector2.up * RayWidth / 2f, Vector2.left, DetectionDistance, TargetLayer, Colors.Gold, true);
                    MMDebug.RayCast(_raycastOrigin - Vector2.up * RayWidth / 2f + Vector2.left * DetectionDistance, Vector2.up, RayWidth, TargetLayer, Colors.Gold, true);
                    _drawLeftGizmo = true;
                }
               ...
               || ((DetectionDirection == DetectionDirections.Back) && (!_character.IsFacingRight)))
            {
                ...
                else
                {
                    ...
                    MMDebug.RayCast(_raycastOrigin + Vector2.up * RayWidth / 2f, Vector2.right, DetectionDistance, TargetLayer, Colors.DarkOrange, true);
                    MMDebug.RayCast(_raycastOrigin - Vector2.up * RayWidth / 2f, Vector2.right, DetectionDistance, TargetLayer, Colors.DarkOrange, true);
                    MMDebug.RayCast(_raycastOrigin - Vector2.up * RayWidth / 2f + Vector2.right * DetectionDistance, Vector2.up, RayWidth, TargetLayer, Colors.DarkOrange, true);
                    _drawLeftGizmo = true;
                }
